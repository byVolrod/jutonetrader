        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          {problems.map((p, i) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.62)' }}>{p.desc}</p>
            </motion.div>
          ))}
        </div>
